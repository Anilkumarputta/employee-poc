...
export default function EmployeeCard({
  ...
  return (
    <div className={`card p-4 ${compact ? "flex items-center gap-4" : ""}`}> 
      ...
      <div className="flex flex-col items-end gap-3">
        ...
        <div className="flex gap-2">
          ...
          {onDelete && (
            <button onClick={onDelete} className="text-sm px-2 py-1 rounded-md border border-transparent text-red-600">
              Delete
            </button>
          )}
        </div>
